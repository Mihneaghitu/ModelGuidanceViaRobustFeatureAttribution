...
def _bound_forward_pass_helper(
    ...
    model = gurobi_utils.init_gurobi_model("Bounds", logfile="gurobi.log")
    ...
    for i in range(0, n_layers):
        ...
        s = mip_formulations.add_bilinear_term(model, W, h, W_l, W_u, h_l, h_u, relax_bilinear)
        ...
        h, _ = mip_formulations.add_relu_constr_bigm(model, s + b, h_l, h_u, relax_binaries)
